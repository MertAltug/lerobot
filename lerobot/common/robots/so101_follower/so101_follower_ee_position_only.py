...
class SO101FollowerEEPositionOnly(SO101Follower):
    """
    ...
    config_class = SO101FollowerEEPositionOnlyConfig
    name = "so100_follower_end_effector"

    def __init__(self, config: SO101FollowerEEPositionOnlyConfig):
